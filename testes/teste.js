...
const questoes = [
  ...
  },
  {
    ...
    },
    {
        ...
        correta: "B",
        explicacao: "O DETRAN exerce poder de polícia administrativa de trânsito, podendo fiscalizar, aplicar penalidades e adotar medidas administrativas previstas no Código de Trânsito Brasileiro."
    },
    {
        ...
        correta: "C",
        explicacao: "O Regimento Interno assegura ao DETRAN autonomia administrativa e financeira, observadas a legislação estadual e as normas que regem a administração pública."
    },
    {
        pergunta: "Acerca do Regimento Interno do DETRAN e do Código de Trânsito Brasileiro (CTB), assinale a alternativa correta. O DETRAN/AL, como órgão executivo de trânsito estadual:",
        alternativas: [
    ...
    {
        pergunta: "Segundo o CTB e o Regimento Interno do DETRAN, compete ao DETRAN:",
        alternativas: [
    ...
    {
        pergunta: "Acerca da estrutura administrativa prevista no Regimento Interno do DETRAN, é correto afirmar que:",
        alternativas: [
        ...
        correta: "C",
        explicacao: "O Regimento Interno do DETRAN prevê estrutura administrativa composta por diretorias, gerências e unidades administrativas."
    },
    {
    ...
    },
    {
        ...
        correta: "C",
        explicacao: "O Regimento Interno assegura ao DETRAN autonomia administrativa e financeira, observadas as normas legais."
    },
    {
    ...
    {
        pergunta: "Acerca da atuação do DETRAN na educação para o trânsito, é correto afirmar que:",
        alternativas: [
    ...
    {
        pergunta: "Segundo o CTB, compete aos órgãos executivos estaduais de trânsito, como o DETRAN, julgar:",
        alternativas: [
    ...
    {
        pergunta: "Conforme o Regimento Interno do DETRAN e os princípios da Administração Pública, é correto afirmar que a atuação do órgão deve observar:",
        alternativas: [
        ...
        correta: "C",
        explicacao: "Como autarquia estadual, o DETRAN submete-se aos princípios constitucionais da Administração Pública, previstos no art. 37 da Constituição Federal."
    },
    {
        pergunta: "À luz do CTB, a integração do DETRAN ao Sistema Nacional de Trânsito implica:",
        alternativas: [
    ...
    {
        pergunta: "Segundo o CTB e o Regimento Interno do DETRAN, no que se refere à educação para o trânsito, é correto afirmar que:",
        alternativas: [
